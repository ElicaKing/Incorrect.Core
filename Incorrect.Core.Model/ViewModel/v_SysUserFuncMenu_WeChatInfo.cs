...
{
    public  class v_SysUserFuncMenu_WeChatInfo
    {
        ...
        public Nullable<int> ReturnMode { get; set; }
        public string ReturnTitlePicture { get; set; }
        public Nullable<int> QyAgentID { get; set; }
    }
}
