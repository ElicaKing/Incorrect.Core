...
{
    public  class v_SysUserFunc_Info
    {
        ...
        public Nullable<int> CusSortID { get; set; }
        public int LevelID { get; set; }
        public string PFuncRecGuid { get; set; }
        ...
        public string TemplateThumbImageFile { get; set; }
        ...
        public int IntegralByTemplateCreate { get; set; }
        public int IntegralByTemplateRead { get; set; }
