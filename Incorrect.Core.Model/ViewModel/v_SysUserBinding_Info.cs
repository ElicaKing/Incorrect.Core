...
{
    public  class v_SysUserBinding_Info
    {
        ...
        public string BindingIdentityName { get; set; }
        public string AuthenticationRecGuid { get; set; }
        public int IsDefault { get; set; }
        public Nullable<int> BindingOrganID { get; set; }
        public string BindingRecGuid { get; set; }
    }
}
